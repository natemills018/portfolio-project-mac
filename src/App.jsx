...
const App = () => {
  ...
  // Wanting to add a background image here, maybe something gray that will blend well with the themes from daisyui?  
  ...
  return (
    <div className="z">
      ...
      >
        ...
        <div className="flex justify-around pt-4 mt-5 space-x-4">
          <BookstoreCard />
          <ChirperCard />
        </div>
        <div className="flex justify-around pt-4 mt-5 space-x-4">
